	...
	public void render(Graphics2D g)
	{
		...
		if (gameStatus == 0)
		{
			...
			if (!selectingDifficulty)
			{
				...
				g.drawString("Space to Start", width / 2 - 150, height / 2 - 25);
				g.drawString("Shift to Play with Bot", width / 2 - 200, height / 2 + 25);
				g.drawString("~Game to " + scoreLimit + " points~", width / 2 - 150, height / 2 + 75);
			}
		}
		if (selectingDifficulty)
		{
			...
			g.setFont(new Font("Arial", 1, 30));
			g.drawString("-PC Level: " + string + " -", width / 2 - 180, height / 2 - 25);
